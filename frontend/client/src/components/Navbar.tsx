    ...
    <nav className="bg-slate-900 text-white shadow-lg">
      <div className="flex items-center justify-between px-8 py-4">
        ...
        <div className="hidden md:flex gap-4 items-center">
          ...
          <Link to="/matching" className="px-4 py-2 hover:bg-green-600 rounded transition duration-200">🏅 Matching</Link>
          ...
          <button onClick={handleLogout} className="px-4 py-2 bg-red-600 hover:bg-red-700 rounded transition duration-200">
            Logout
          </button>
        </div>

        {/* Hamburger */}
        <button onClick={toggleMenu} className="md:hidden flex flex-col gap-1.5 focus:outline-none">
      ...
      {isOpen && (
        <div className="md:hidden bg-slate-800 px-8 py-4 space-y-2">
          ...
          <Link to="/matching" onClick={() => setIsOpen(false)} className="block px-4 py-2 hover:bg-green-600 rounded transition duration-200">🏅 Matching</Link>
